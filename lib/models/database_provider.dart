...
class DatabaseProvider with ChangeNotifier {
  ...
  Future<void> sortExpensesByDate({required bool ascending}) async {
  ...
  Future<void> addExpense(Expense exp) async {
    ...
    await db.transaction((txn) async {
      await txn
        ...
        final file = Expense(id: generatedId, title: exp.title, amount: exp.amount, date: exp.date, category: exp.category, description: exp.description);
